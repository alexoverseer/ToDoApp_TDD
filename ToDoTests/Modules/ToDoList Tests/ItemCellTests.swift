...
class ItemCellTests: XCTestCase {
    ...
    func test_Title_WhenItemIsChecked_IsStrokeThrough() {
        ...
        let attributes = [NSAttributedStringKey.strikethroughStyle: NSUnderlineStyle.styleSingle.rawValue]
        let attributedString = NSAttributedString(string: "Foo", attributes: attributes)
